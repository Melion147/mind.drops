...
function toggleClasses() {
    ...
    document.querySelector('.wrap').classList.toggle('z-100');
    document.querySelector('.modal').classList.toggle('is-active')
    setTimeout(function() {
        document.querySelector('.rope-img').classList.toggle('filter-blur');
        document.querySelector('.counter').classList.toggle('filter-blur');
        document.querySelector('.wrapper').classList.toggle('filter-blur');
        document.querySelector('.glider').classList.toggle('filter-blur');
    }, 350);
